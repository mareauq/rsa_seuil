...
{
    FILE* fptr;
    fptr = fopen("./Verifier_El_Gamal/Message.txt", "r");
...
{
    FILE* fptr;
    fptr = fopen("./Verifier_El_Gamal/Message_dechiffre.txt", "r");
...
int verify_message_signature(mpz_t Hashed_Message, mpz_t Signature)
{
    int valid_signature = (mpz_cmp(Signature, Hashed_Message) == 0);
